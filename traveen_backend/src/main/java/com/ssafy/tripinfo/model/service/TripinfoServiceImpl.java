...
public class TripinfoServiceImpl implements TripinfoService {
	...
	@Override
	public List<Tripinfo> listTripinfo(Tripinfo tripinfo) throws Exception {
...
//		param.put("listsize", SizeConstant.TRIPINFO_LIST_SIZE);
		...
		return tripinfoMapper.listTripinfo(tripinfo);
	}

	@Override
	public int getTotalTripinfoCount(Tripinfo tripinfo) throws Exception {
		return tripinfoMapper.getTotalTripinfoCount(tripinfo);
	}
